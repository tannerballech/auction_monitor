...
def _db_to_listing(row: dict) -> dict:
    ...
    return {
        ...
        "Owner First Name":              row.get("owner_first", "") or "",
        "Owner Last Name":               row.get("owner_last", "") or "",
        "Owner First Name (Secondary)":  row.get("owner_secondary_first", "") or "",
        "Owner Last Name (Secondary)":   row.get("owner_secondary_last", "") or "",
